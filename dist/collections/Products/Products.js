...
var syncUser = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var fullUser, products, allIDs_1, createdProductdIDs, dataToUpdate;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    createdProductdIDs = allIDs_1.filter(function (id, index) { return allIDs_1.indexOf(id) === index; });
                    dataToUpdate = __spreadArray(__spreadArray([], createdProductdIDs, true), [doc.id], false);
